...
public class AuthExceptionHandler {
    // TODO: we should consider returning JSON body with a message field instead of this brutish raw text
    ...
    public ResponseEntity<String> handleGeneralAuthError(){
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Unknown authentication error occurred");
    }
}
