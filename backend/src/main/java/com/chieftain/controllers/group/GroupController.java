...
public class GroupController {
    ...
    public GroupController(GroupService groupService, UserService userService, CustomUserDetailsService customUserDetailsService) {
    ...
    @PutMapping("/create")
    @Transactional
    public ResponseEntity<GroupCreateResponseDTO> createGroup(@Valid @RequestBody GroupCreateRequestDTO request, @AuthenticationPrincipal CustomUserDetails userDetails){
